...
def main():
    """ReadData & Plotgraph"""
    chart = pygal.Bar(title=' Graph of Unemployment (Percentage), Central Region: 2550 - 2559 ') #Name of graph
    datalist = [] #List for keep data
    address = 'C:/Users/HP/Documents/GitHub/Main_Psit_Project2017/Data/Unemployed_Central_Percentage.csv' #Address file
