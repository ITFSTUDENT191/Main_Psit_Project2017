...
def main():
    ...
    plt.xticks(x, xtick)
    plt.plot(x, y_01, color="red", marker="o", label=("ประถมหรือตํ่ากว่า"))
    plt.plot(x, y_02, color="green", marker="o", label=("มัธยมต้น"))
    plt.plot(x, y_03, color="blue", marker="o", label=("มัธยมปลาย"))
    plt.plot(x, y_04, color="orange", marker="o", label=("อาชีวศึกษา"))
    plt.plot(x, y_05, color="pink", marker="o", label=("วิชาชีพขั้นสูง"))
    plt.plot(x, y_06, color="brown", marker="o", label=("อุดมศึกษา"))
