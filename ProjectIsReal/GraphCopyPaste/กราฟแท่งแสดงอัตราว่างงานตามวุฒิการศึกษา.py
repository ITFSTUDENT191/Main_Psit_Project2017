...
def main():
    ...
    plt.bar([1, 8, 15, 22, 29, 36, 43, 50, 57, 64], y_1, label="ประถมหรือตํ่ากว่า", width=1, color="cyan")
    plt.bar([2, 9, 16, 23, 30, 37, 44, 51, 58, 65], y_2, label="มัธยมต้น", width=1, color="skyblue")
    plt.bar([3, 10, 17, 24, 31, 38, 45, 52, 59, 66], y_3, label="มัธยมปลาย", width=1, color="cadetblue")
    plt.bar([4, 11, 18, 25, 32, 39, 46, 53, 60, 67], y_4, label="อาชีวศึกษา", width=1, color="blue")
    plt.bar([5, 12, 19, 26, 33, 40, 47, 54, 61, 68], y_5, label="วิชาชีพขั้นสูง", width=1, color="royalblue")
    plt.bar([6, 13, 20, 27, 34, 41, 48, 55, 62, 69], y_6, label="อุดมศึกษา", width=1, color="midnightblue")
